RSpec.describe 'HTML Album Cover' do
    ...
    context 'within <body>' do
      it 'the title-box section contains the correct header sizes and text content'do
        ...
        expect(title_box.children.any? {|ch| ch.name == 'h2'}).to be == true
      ...
      it 'the back section contains the correct header sizes and text content' do
        ...
        expect(back_cover.children.any? {|ch| ch.name == 'h3'}).to be == true
        ...
        expect(back_cover.children.any? {|ch| ch.name == 'h1'}).to be == true
        ...
        expect(back_cover.children.any? {|ch| ch.name == 'p'}).to be == true
        ...
        expect(back_cover.children.any? {|ch| ch.name == "span"}).to be == true
